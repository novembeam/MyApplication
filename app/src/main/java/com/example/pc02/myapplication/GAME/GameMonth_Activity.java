...
public class GameMonth_Activity extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_game_month);


        DatabaseHelper db= new DatabaseHelper(this);
        quesList = db.getAllQuestions06();
        ...
        mquestionBank.initQuestions06(getApplicationContext());
        setQuestionView();
        updateScore(mScore);
        ...
        home.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent home = new Intent(GameMonth_Activity.this, List_GameActivity.class);
                startActivity(home);
                finish();
            }
        });
    ...
    private void setQuestionView() {
        ...
        if (mQuestionNumber < mquestionBank.getLength()) {
            ...
            Toast.makeText(GameMonth_Activity.this, "ถึงข้อสุดท้ายแล้วนะ!", Toast.LENGTH_SHORT).show();
            Intent intent = new Intent(GameMonth_Activity.this, HighestScore_Abc_Activity.class);
    ...
    public void onClick(View view) {
        ...
        if (answer.getText().equals(mAnswer)){
            mScore = mScore + 1;
            Toast.makeText(GameMonth_Activity.this, "เก่งมากจ้า!", Toast.LENGTH_SHORT).show();
            // show current total score for the user
            updateScore(mScore);
            // once user answer the question, we move on to the next one, if any
            setQuestionView();
        }else{
            Toast.makeText(GameMonth_Activity.this, "ลองใหม่อีกทีนะ!", Toast.LENGTH_SHORT).show();
            //mScore = mScore + 0;
            updateScore(mScore);
            setQuestionView();
        }
