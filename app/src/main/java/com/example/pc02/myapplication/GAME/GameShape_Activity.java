...
public class GameShape_Activity extends AppCompatActivity implements View.OnClickListener{
    ...
    private int mlength = 0;  // current length score
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mquestionBank.initQuestions08(getApplicationContext());
        setQuestionView();
        updateScore(mScore);
        //updateQuizDoNow(mScore);
        ...
        home.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent home = new Intent(GameShape_Activity.this, List_GameActivity.class);
                startActivity(home);
                finish();
            }
        });
    ...
    private void setQuestionView() {
        ...
        if (mQuestionNumber < mquestionBank.getLength()) {
            ...
            Toast.makeText(GameShape_Activity.this, "ถึงข้อสุดท้ายแล้วนะ!", Toast.LENGTH_SHORT).show();
            Intent intent = new Intent(GameShape_Activity.this, HighestScore_Shape_Activity.class);
    ...
    private void updateQuizDoNow(int point) {
        //mScoreView.setText(""+(score + 0));
        //mQuizLength.setText(""+score+"/"+mquestionBank.getLength());
    }
    ...
    public void onClick(View view) {
        ...
        if (answer.getText().equals(mAnswer)){
            mScore = mScore + 1;
            Toast.makeText(GameShape_Activity.this, "เก่งมากจ้า!", Toast.LENGTH_SHORT).show();
            // show current total score for the user
            updateScore(mScore);
            // once user answer the question, we move on to the next one, if any
            setQuestionView();
        }else{
            Toast.makeText(GameShape_Activity.this, "ลองใหม่อีกทีนะ!", Toast.LENGTH_SHORT).show();
            //mlength = mScore + 1;
            updateScore(mScore);
            setQuestionView();
        }
