...
public class HighestScore_Day_Activity extends AppCompatActivity implements View.OnClickListener {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_highest_score__day);
    ...
    public void onClick(View view) {
        ...
        Intent intent = new Intent(HighestScore_Day_Activity.this, List_GameActivity.class);
