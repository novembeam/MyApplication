...
public class HighestScore_Color_Activity extends AppCompatActivity implements View.OnClickListener {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_highest_score__color);
    ...
    public void onClick(View view) {
        ...
        Intent intent = new Intent(HighestScore_Color_Activity.this, List_GameActivity.class);
