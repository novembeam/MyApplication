...
public class HighestScore_Month_Activity extends AppCompatActivity implements View.OnClickListener {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_highest_score__month);
    ...
    public void onClick(View view) {
        ...
        Intent intent = new Intent(HighestScore_Month_Activity.this, List_GameActivity.class);
