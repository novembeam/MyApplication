...
public class v_monthActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_v_month);
        getSupportActionBar().hide();

        vdoView = (VideoView)findViewById(R.id.videoView);

        videoLocation = Uri.parse("android.resource://" + getPackageName() + "/" + R.raw.month_video);
