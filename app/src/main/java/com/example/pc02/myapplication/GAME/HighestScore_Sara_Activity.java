...
public class HighestScore_Sara_Activity extends AppCompatActivity implements View.OnClickListener {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_highest_score__sara);
    ...
    public void onClick(View view) {
        ...
        Intent intent = new Intent(HighestScore_Sara_Activity.this, List_GameActivity.class);
