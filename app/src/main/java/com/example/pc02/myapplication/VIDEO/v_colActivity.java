...
public class v_colActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_v_col);

        getSupportActionBar().hide();

        vdoView = (VideoView)findViewById(R.id.videoView);

        videoLocation = Uri.parse("android.resource://" + getPackageName() + "/" + R.raw.color_video);
