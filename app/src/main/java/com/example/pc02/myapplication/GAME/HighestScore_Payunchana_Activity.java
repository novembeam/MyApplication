...
public class HighestScore_Payunchana_Activity extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onClick(View view) {
        ...
        Intent intent = new Intent(HighestScore_Payunchana_Activity.this, List_GameActivity.class);
