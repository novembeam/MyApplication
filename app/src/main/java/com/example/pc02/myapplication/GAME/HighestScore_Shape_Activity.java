...
public class HighestScore_Shape_Activity extends AppCompatActivity implements View.OnClickListener {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_highest_score__shape);
    ...
    public void onClick(View view) {
        ...
        Intent intent = new Intent(HighestScore_Shape_Activity.this, List_GameActivity.class);
